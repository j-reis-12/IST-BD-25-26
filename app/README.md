...
6. We will set the `DATABASE_URL` to use the database. Note that you need to replace the URL using your information.

   ```bash
   flyctl secrets set DATABASE_URL='postgres://username:password@hostname:port/databasename'
   ```
...
6. We will set the `DATABASE_URL` to use the database from Tecnico. Note that you need to replace the URL using your information.
